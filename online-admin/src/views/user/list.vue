<template>
  <div class="app-container">
    <h1>用户列表</h1>
    <!-- 条件查询表单 -->
    <el-form :inline="true" :model="queryDTO" class="demo-form-inline">
      <el-form-item label="姓名">
        <el-input v-model="queryDTO.nickname" placeholder="请输入姓名"></el-input>
      </el-form-item>
      <el-form-item label="手机号">
        <el-input v-model="queryDTO.mobile" placeholder="请输入手机号"></el-input>
      </el-form-item>

      <el-form-item label="加入时间">
        <el-date-picker
          v-model="queryDTO.begin"
          type="month"
          placeholder="选择开始时间"
      ...
      <el-form-item>
        ...
        <el-button round type="danger " icon="el-icon-delete" @click="resetQueryDTO()">清空</el-button>
      </el-form-item>
    </el-form>
    <!-- 结果展示列表 -->
    <el-table
    ...
    >
      <el-table-column prop="id" label="用户 Id" width="250" align="center"></el-table-column>
      ...
      <el-table-column label="操作" width="200" align="center" fixed="right">
        <template slot-scope="scope">
          ...
          >
            ...
            <div class="demo-drawer__content">
              <el-form :model="userInfo">
                <el-form-item label="昵称" :label-width="formLabelWidth" style=" font-size: 15px">
                ...
                >
                  <el-select size="medium" v-model="userInfo.sex" clearable placeholder="请选择">
                    <!--  
            ...
            因此，这里value使用动态绑定的值，保证其数据类型是number
                ...
                <el-form-item label="年龄" :label-width="formLabelWidth" style=" font-size: 15px">
          ...
          <el-popconfirm
            ...
            @confirm="removeUser(scope.row.id,scope.row.nickname)"
            cancelButtonText="取消"
            icon="el-icon-info"
            iconColor="red"
            title="将永久删除用户, 是否继续?"
...
import userApi from "@/api/edu/user.js";
...
export default {
  ...
  methods: {
    ...
    getList(page = 1) {
      this.queryDTO.current = page;

      this.queryDTO.size = this.size;
      userApi.getUserList(this.queryDTO).then((response) => {
        // 请求成功

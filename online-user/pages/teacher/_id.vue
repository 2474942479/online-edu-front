        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            <section class="t-infor-pic">
              <img :src="teacher.avatar" width="300px" height="300px" />
            </section>
            <h3 class="hLh30">
              ...
              <li v-for="course in courseList" :key="course.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    ...
                    <div class="cc-mask">
                      <a :href="'/course/'+course.id" title="开始学习" target="_top" class="comm-btn c-btn-1">开始学习</a>
                    </div>
                  </section>
...
export default {
  ...
  //     teacherApi.getTeacherAll(this.$route.params.id).then((response) => {
